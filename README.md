<div align="center">
  <img src="./assets/logo.png" alt="Meeting Productivity Impact" width="600">
</div>
...
Synapse is an innovative AI-powered scheduling assistant that autonomously coordinates meetings, resolves conflicts, and optimizes calendar schedules. Built for the AMD AI Hackathon, it leverages advanced Agentic AI to transform workplace productivity by eliminating the inefficiencies of manual scheduling.
...
Synapse addresses these pain points through:
- **Autonomous Scheduling**: Complete meeting coordination without human intervention
- **Conflict Resolution**: Intelligent handling of scheduling conflicts and overlaps
- **Natural Language Processing**: Conversational meeting requests using DeepSeek LLM
- **Calendar Integration**: Seamless Google Calendar synchronization
- **Time Optimization**: Recovery of up to 31 hours per employee monthly

## ✨ Features

### Core Capabilities
- 🤖 **Autonomous Meeting Coordination** - Full end-to-end scheduling without manual intervention
- 🧠 **Natural Language Processing** - Schedule meetings using conversational requests
...
- 🎯 **Preference Learning** - Honors time preferences (morning, afternoon, specific hours)
- 🌐 **Multi-timezone Support** - Handles scheduling across different time zones

### Technical Features
- **vLLM Server Integration** - Leverages DeepSeek LLM for language understanding
- **Google Calendar API** - Full calendar access and event management
- **Flask REST API** - Simple HTTP interface for integration
...
│ (Natural Lang)  │    │   (Port 5000)   │    │  (DeepSeek LLM) │
└─────────────────┘    └─────────────────┘    └─────────────────┘
                                │
                                ▼
                       ┌─────────────────┐
...
3. **Set up Google Calendar credentials**
   ...
   - Format: `userone.amd.json`, `userone.amd.token`
...
The system currently supports IST (Asia/Kolkata) with plans for multi-timezone support.

## 🏆 Evaluation Criteria

Synapse excels in key evaluation areas:
...
- **🎨 Creativity**: Innovative natural language processing and autonomous scheduling

## 📈 Impact & Benefits

### Productivity Gains
- **31 hours/month** saved per employee
- **Up to $420,000** annual savings for mid-sized organizations
- **Conflict reduction** through intelligent scheduling
- **Stress reduction** via automated coordination

### Technical Advantages
- **Natural Language Interface** - No complex forms or rigid inputs
- **Autonomous Operation** - Minimal human intervention required
- **Scalable Architecture** - Handles multiple simultaneous requests
- **Extensible Design** - Easy integration with other calendar systems
...
- [ ] **Integration Plugins** - Slack, Teams, Outlook support
- [ ] **Mobile Application** - iOS and Android apps
- [ ] **Analytics Dashboard** - Meeting productivity insights
